...
import type { Coord, GridDirs, Inspectable, InspectionData, Puppet, PuppetCommand } from "../types";
import {
	MovableObjectGrid,
	type MovableObjectGridConfig,
 ...
 */
export class GridCharacter extends MovableObjectGrid implements Puppet, Inspectable {
