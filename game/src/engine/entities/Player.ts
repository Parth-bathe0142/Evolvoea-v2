...
export class Player extends GridCharacter {
	...
	constructor(config: PlayerConfig) {
		config.spriteConfig.animations = {
			"idle-down": [{ frame: { x: 0, y: 0 } }],
			"idle-left": [{ frame: { x: 0, y: 2 } }],
			"idle-up": [{ frame: { x: 0, y: 1 } }],
			"idle-right": [{ frame: { x: 0, y: 3 } }],
			"walk-down": [
				{ frame: { x: 0, y: 0 } },
				{ frame: { x: 2, y: 0 } },
				{ frame: { x: 0, y: 0 } },
			...
			"bob-down": [
				...
				{ frame: { x: 1, y: 0 }, duration: 16 },
			],
			"bob-left": [
				{ frame: { x: 0, y: 2 }, duration: 16 },
				{ frame: { x: 1, y: 2 }, duration: 16 },
			],
			"bob-up": [
				{ frame: { x: 0, y: 1 }, duration: 16 },
				{ frame: { x: 1, y: 1 }, duration: 16 },
			],
			"bob-right": [
				{ frame: { x: 0, y: 3 }, duration: 16 },
				{ frame: { x: 1, y: 3 }, duration: 16 },
			],
		};
